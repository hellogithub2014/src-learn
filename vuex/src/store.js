...
export class Store {
  ...
  commit(_type, _payload, _options) {
    ...
    /**
     * 在registerMutation中设置_mutations：
     *
  ...
  // 执行fn时令_committing为true，会受到enableStrictMode中watch的保护，
  // 改变state时不会触发报错
  _withCommit(fn) {
