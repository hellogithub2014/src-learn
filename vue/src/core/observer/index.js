...
export class Observer {
  ...
  // Observer是Dep和Watcher之间的桥梁，通过Observer可以为被观察对象设置Dep，
  // 然后在特定时刻与Dep.target这个Watcher互相关心，从而建立联系
  ...
  Object.defineProperty( obj, key, {
    ...
    get: function reactiveGetter () {
      ...
      if ( Dep.target )
      {
        ...
        if ( childOb )
        {
          // 例如模板中有{{o.a}}，当o或者o.a变化时都需要触发watcher
...
export function set ( target: Array<any> | Object, key: any, val: any ): any {
  ...
  if ( Array.isArray( target ) && isValidArrayIndex( key ) )
  {
    ...
    target.splice( key, 1, val )  // splice方法已经被拦截过了，val会被observe
    return val
  }
  if ( key in target && !( key in Object.prototype ) )
  {
    target[ key ] = val // 触发setter。val会被observe
    return val
  }
